...
## Out-of-scope global patterns
- Do not apply Prisma/Zod server-action conventions from generic global backend guides here.
- Do not introduce Next.js server action patterns into NestJS backend code.
